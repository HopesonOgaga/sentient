...
function SentientFeedback() {
  ...
  // ✅ Submit handler (serverTimestamp only)
  const handleSubmit = async (e) => {
    ...
    await addDoc(collection(db, "submissions"), {
      ...
      createdAt: serverTimestamp(), // server time only
    });
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-pink-300 via-white to-gray-100 flex flex-col items-center p-6">
      {/* Header */}
      ...
      {submissions.length > 0 && (
        <div className="w-full max-w-2xl bg-white shadow rounded-2xl p-6 space-y-4">
